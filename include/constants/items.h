...
enum __attribute__((packed)) Item
{
    ...
    ITEM_JUBILIFE_MUFFIN = 836,
    ITEM_REMEDY = 837,
    ITEM_FINE_REMEDY = 838,
    ITEM_SUPERB_REMEDY = 839,
    ITEM_AUX_EVASION = 840,
    ITEM_AUX_GUARD = 841,
    ITEM_AUX_POWER = 842,
    ITEM_AUX_POWERGUARD = 843,
    ITEM_CHOICE_DUMPLING = 844,
    ITEM_SWAP_SNACK = 845,
    ITEM_TWICE_SPICED_RADISH = 846,
    ITEM_POKESHI_DOLL = 847,

    ITEM_STRANGE_BALL = 848,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 849,
    ITEM_VICTREEBELITE = 850,
    ITEM_STARMINITE = 851,
    ITEM_DRAGONINITE = 852,
    ITEM_MEGANIUMITE = 853,
    ITEM_FERALIGITE = 854,
    ITEM_SKARMORITE = 855,
    ITEM_FROSLASSITE = 856,
    ITEM_EMBOARITE = 857,
    ITEM_EXCADRITE = 858,
    ITEM_SCOLIPITE = 859,
    ITEM_SCRAFTINITE = 860,
    ITEM_EELEKTROSSITE = 861,
    ITEM_CHANDELURITE = 862,
    ITEM_CHESNAUGHTITE = 863,
    ITEM_DELPHOXITE = 864,
    ITEM_GRENINJITE = 865,
    ITEM_PYROARITE = 866,
    ITEM_FLOETTITE = 867,
    ITEM_MALAMARITE = 868,
    ITEM_BARBARACITE = 869,
    ITEM_DRAGALGITE = 870,
    ITEM_HAWLUCHANITE = 871,
    ITEM_ZYGARDITE = 872,
    ITEM_DRAMPANITE = 873,
    ITEM_FALINKSITE = 874,
    ...
    ITEM_DARKRANITE = 876,
    ITEM_ZERAORITE = 877,
    ITEM_RAICHUNITE_X = 878,
    ITEM_RAICHUNITE_Y = 879,
    ITEM_CHIMECHITE = 880,
    ITEM_ABSOLITE_Z = 881,
    ITEM_STARAPTITE = 882,
    ITEM_GARCHOMPITE_Z = 883,
    ITEM_LUCARIONITE_Z = 884,
    ITEM_GOLURKITE = 885,
    ITEM_MEOWSTICITE = 886,
    ITEM_CRABOMINITE = 887,
    ITEM_GOLISOPITE = 888,
    ITEM_MAGEARNITE = 889,
    ITEM_SCOVILLAINITE = 890,
    ITEM_BAXCALIBRITE = 891,
    ITEM_TATSUGIRINITE = 892,
    ITEM_GLIMMORANITE = 893,

    //DW Custom Items
    ITEM_ULTRA_REPEL = 894,
...
enum EffectItem
{
    EFFECT_ITEM_ENIGMA_BERRY_EREADER = 21, // dummy constant
    EFFECT_ITEM_RESTORE_HP = 21, // needs to be non-zero
