...
// Contest maps may be removed from projects that do not use the vanilla map set,
// but the contest engine still uses these local IDs internally.
...
// Fallback IDs referenced by optional vanilla systems whose maps were removed.
...
#define LOCALID_GENERATED_OWE 1
...
#define LOCALID_ROUTE111_TY_1 1
#define LOCALID_ROUTE111_TY_2 1
#define LOCALID_ROUTE111_TY_3 1
#define LOCALID_ROUTE118_GABBY_1 1
#define LOCALID_ROUTE118_GABBY_2 1
#define LOCALID_ROUTE118_GABBY_3 1
#define LOCALID_ROUTE118_TY_1 1
#define LOCALID_ROUTE118_TY_2 1
#define LOCALID_ROUTE118_TY_3 1
#define LOCALID_ROUTE120_GABBY_1 1
#define LOCALID_ROUTE120_GABBY_2 1
#define LOCALID_ROUTE120_TY_1 1
#define LOCALID_ROUTE120_TY_2 1
...
// Fallback IDs used only by shared scripts for removed vanilla maps.
#define LOCALID_APPRENTICE 1
#define LOCALID_BLEND_MASTER 1
#define LOCALID_CAPE_BRINK_TUTOR 1
#define LOCALID_CONTEST_ARTIST 1
#define LOCALID_CONTEST_AUDIENCE_1 1
#define LOCALID_CONTEST_AUDIENCE_2 2
#define LOCALID_CONTEST_AUDIENCE_3 3
#define LOCALID_CONTEST_AUDIENCE_4 4
#define LOCALID_CONTEST_AUDIENCE_5 5
#define LOCALID_CONTEST_AUDIENCE_6 6
#define LOCALID_CONTEST_AUDIENCE_7 7
#define LOCALID_CONTEST_JUDGE 1
#define LOCALID_CONTEST_LOBBY_BLENDER_2_LEADER 1
#define LOCALID_CONTEST_LOBBY_BLENDER_2_PARTICIPANT 2
#define LOCALID_CONTEST_LOBBY_BLENDER_3_LEADER 1
#define LOCALID_CONTEST_LOBBY_BLENDER_3_PARTICIPANT_1 2
#define LOCALID_CONTEST_LOBBY_BLENDER_3_PARTICIPANT_2 3
#define LOCALID_CONTEST_MC 1
#define LOCALID_CONTEST_POKEBALL 1
...
#define LOCALID_TOWER_TRAINER_DOUBLES1 1
#define LOCALID_TOWER_TRAINER_DOUBLES2 2
#define LOCALID_TOWER_TRAINER_KNOCKOUT 1
#define LOCALID_TOWER_TRAINER_SINGLES 1
#define LOCALID_VERMILION_FERRY_SAILOR 1
#define LOCALID_TOWER_ATTENDANT_SINGLES 1
#define LOCALID_TOWER_ATTENDANT_DOUBLES 2
#define LOCALID_TOWER_ATTENDANT_MULTIS 3
#define LOCALID_TOWER_ATTENDANT_LINK_MULTIS 4
#define LOCALID_FRONTIER_SUDOWOODO 1
#define LOCALID_SOUTHERN_ISLAND_SAILOR 1
#define LOCALID_SOUTHERN_ISLAND_SS_TIDAL 2
#define LOCALID_TRAINER_HILL_NURSE 1
#define LOCALID_BRANDON 1
#define LOCALID_BRIDGE_KECLEON 1
#define LOCALID_BRIDGE_KECLEON_SHADOW 2
#define LOCALID_KIRI 1
#define LOCALID_MAUVILLE_SCOTT 1
#define LOCALID_MAUVILLE_WALLY 2
#define LOCALID_MAUVILLE_WALLYS_UNCLE 3
#define LOCALID_PIKE_CORRIDOR_ATTENDANT 1
#define LOCALID_PIKE_HINT_GIVER 1
#define LOCALID_PIKE_LOBBY_ATTENDANT 1
#define LOCALID_PYRAMID_TOP_ATTENDANT 1
#define LOCALID_ROUTE119_RIVAL 1
#define LOCALID_ROUTE119_RIVAL_ON_BIKE 2
#define LOCALID_ROUTE119_SCOTT 3
#define LOCALID_ROUTE120_STEVEN 1
#define LOCALID_RUSTURF_TUNNEL_BRINEY 1
#define LOCALID_RUSTURF_TUNNEL_GRUNT 2
#define LOCALID_RUSTURF_TUNNEL_PEEKO 3
#define LOCALID_RUSTURF_TUNNEL_WANDA 4
#define LOCALID_RUSTURF_TUNNEL_WANDAS_BF 5
#define LOCALID_SKY_PILLAR_WALLACE 1
#define LOCALID_SOOTOPOLIS_ARCHIE 1
#define LOCALID_SOOTOPOLIS_BLACK_BELT 2
#define LOCALID_SOOTOPOLIS_BOY_1 3
#define LOCALID_SOOTOPOLIS_BOY_2 4
#define LOCALID_SOOTOPOLIS_EXPERT 5
#define LOCALID_SOOTOPOLIS_GIRL 6
#define LOCALID_SOOTOPOLIS_GROUDON 7
#define LOCALID_SOOTOPOLIS_KYOGRE 8
#define LOCALID_SOOTOPOLIS_MANIAC 9
#define LOCALID_SOOTOPOLIS_MAXIE 10
#define LOCALID_SOOTOPOLIS_NINJA_BOY 11
#define LOCALID_SOOTOPOLIS_RAYQUAZA 12
#define LOCALID_SOOTOPOLIS_STEVEN 13
#define LOCALID_SOOTOPOLIS_WALLACE 14
#define LOCALID_SOOTOPOLIS_WOMAN_1 15
#define LOCALID_SOOTOPOLIS_WOMAN_2 16
#define LOCALID_SPACE_CENTER_2F_GENTLEMAN 1
#define LOCALID_SPACE_CENTER_2F_RICH_BOY 2
#define LOCALID_SPACE_CENTER_2F_SCIENTIST 3
#define LOCALID_SPACE_CENTER_2F_STEVEN 4
#define LOCALID_SPACE_CENTER_GRUNT_5 5
#define LOCALID_SPACE_CENTER_GRUNT_6 6
#define LOCALID_SPACE_CENTER_GRUNT_7 7
#define LOCALID_SPACE_CENTER_MAXIE 8
#define LOCALID_SPACE_CENTER_TABITHA 9
#define LOCALID_SS_TIDAL_EXIT_SAILOR 1
#define LOCALID_SS_TIDAL_SCOTT 2
#define LOCALID_TOWER_BATTLE_ATTENDANT_1 1
#define LOCALID_TOWER_BATTLE_ATTENDANT_2 2
#define LOCALID_TOWER_BATTLE_OPPONENT 3
#define LOCALID_TOWER_MULTI_BATTLE_ATTENDANT_1 1
#define LOCALID_TOWER_MULTI_BATTLE_ATTENDANT_2 2
#define LOCALID_TOWER_MULTI_BATTLE_OPPONENT_1 3
#define LOCALID_TOWER_MULTI_BATTLE_OPPONENT_2 4
#define LOCALID_TOWER_MULTI_BATTLE_PARTNER 5
#define LOCALID_TOWER_MULTI_BATTLE_PLAYER 6
#define LOCALID_TOWER_PARTNER_ROOM_ATTENDANT 1
#define LOCALID_TRAINER_HILL_ATTENDANT 1
#define LOCALID_TRAINER_HILL_GIRL 2
#define LOCALID_TRAINER_HILL_MAN 3
#define LOCALID_TRICK_MASTER 1

// Values referenced only inside the preserved compatibility scripts below.
#define LAYOUT_SOOTOPOLIS_CITY_LEGENDS_BATTLE 0
#define VAR_RUSTBORO_CITY_STATE VAR_STONEREACH_CITY_STATE
...
#define OBJ_EVENT_GFX_ACE_TRAINER_F              243
...
#define OBJ_EVENT_GFX_GENTLEMAN_FRLG             388
...
#define OBJ_EVENT_PAL_TAG_MAN_2                     0x117E
