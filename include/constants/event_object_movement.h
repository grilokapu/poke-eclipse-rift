...
#define MOVEMENT_TYPE_WALK_IN_PLACE_DOWN_SLOWER        0x53
#define MOVEMENT_TYPE_WANDER_AROUND_OWE                0x54
#define MOVEMENT_TYPE_CHASE_PLAYER_OWE                 0x55
#define MOVEMENT_TYPE_FLEE_PLAYER_OWE                  0x56
...
#define MOVEMENT_TYPE_QUEST_ICON_FACE_DOWN             0x5A
#define MOVEMENT_TYPE_QUEST_ICON_FACE_UP               0x5B
#define MOVEMENT_TYPE_QUEST_ICON_FACE_LEFT             0x5C
#define MOVEMENT_TYPE_QUEST_ICON_FACE_RIGHT            0x5D
#define NUM_MOVEMENT_TYPES                             0x5E
...
//backwards movement
#define MOVEMENT_ACTION_WALK_NORMAL_DOWN_BACKWARDS       0xB6
#define MOVEMENT_ACTION_WALK_NORMAL_UP_BACKWARDS         0xB7
#define MOVEMENT_ACTION_WALK_NORMAL_LEFT_BACKWARDS       0xB8
#define MOVEMENT_ACTION_WALK_NORMAL_RIGHT_BACKWARDS      0xB9
#define MOVEMENT_ACTION_WALK_SLOW_DOWN_BACKWARDS         0xBA
#define MOVEMENT_ACTION_WALK_SLOW_UP_BACKWARDS           0xBB
#define MOVEMENT_ACTION_WALK_SLOW_LEFT_BACKWARDS         0xBC
#define MOVEMENT_ACTION_WALK_SLOW_RIGHT_BACKWARDS        0xBD
#define MOVEMENT_ACTION_JUMP_DOWN_BACKWARDS              0xBE
#define MOVEMENT_ACTION_JUMP_UP_BACKWARDS                0xBF
#define MOVEMENT_ACTION_JUMP_LEFT_BACKWARDS              0xC0
#define MOVEMENT_ACTION_JUMP_RIGHT_BACKWARDS             0xC1
//New Emote
#define MOVEMENT_ACTION_EMOTE_SMILE                      0xC2
#define MOVEMENT_ACTION_EMOJI_ANGRY		 	   		     0xC3
#define MOVEMENT_ACTION_EMOJI_BLUSH 		 	   		 0xC4
#define MOVEMENT_ACTION_EMOJI_CONFIANT		 	   		 0xC5
#define MOVEMENT_ACTION_EMOJI_CONFIDENT		 	   		 0xC6
#define MOVEMENT_ACTION_EMOJI_COFIDENT_SMILING 			 0xC7
#define MOVEMENT_ACTION_EMOJI_DOUBT		 	   		 	 0xC8
#define MOVEMENT_ACTION_EMOJI_GRIN		 	   		 	 0xC9
#define MOVEMENT_ACTION_EMOJI_HEART_EYES		 	     0xCA
#define MOVEMENT_ACTION_EMOJI_INNOCENT		 	     	 0xCB
#define MOVEMENT_ACTION_EMOJI_JOY		 	   		 	 0xCC
#define MOVEMENT_ACTION_EMOJI_KISSING		 	     	 0xCD
#define MOVEMENT_ACTION_EMOJI_RELAXED		 	     	 0xCE
#define MOVEMENT_ACTION_EMOJI_RELIVIED		 	     	 0xCF
#define MOVEMENT_ACTION_EMOJI_SCREAM		 	     	 0xD0
#define MOVEMENT_ACTION_EMOJI_SLITHLY		 	 		 0xD1
#define MOVEMENT_ACTION_EMOJI_SMILEY		 	     	 0xD2
#define MOVEMENT_ACTION_EMOJI_SOB		 	   		 	 0xD3
#define MOVEMENT_ACTION_EMOJI_THINKING		 	     	 0xD4
#define MOVEMENT_ACTION_EMOJI_TONGUE_WINKING		 	 0xD5
#define MOVEMENT_ACTION_EMOJI_WINK 		 	     	 	 0xD6
#define MOVEMENT_ACTION_EMOJI_YUM		 	     	 	 0xD7
#define MOVEMENT_ACTION_WALK_FASTER_DOWN_BACKWARDS       0xD8
#define MOVEMENT_ACTION_WALK_FASTER_UP_BACKWARDS         0xD9
#define MOVEMENT_ACTION_WALK_FASTER_LEFT_BACKWARDS       0xDA
#define MOVEMENT_ACTION_WALK_FASTER_RIGHT_BACKWARDS      0xDB
