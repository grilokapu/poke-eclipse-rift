...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x264 // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x265 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x266 // Allow player to find hidden mons
