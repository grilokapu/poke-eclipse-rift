...
#define WE_FLAG_NO_ENCOUNTER        0x295       // If this flag is set, wild encounters will be disabled.
...
#define WE_SMART_WILD_AI_FLAG        0x294     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          0x292     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           0x293     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
