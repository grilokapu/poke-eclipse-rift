...
{
    [MAPSEC_PINEVEIL_TOWN] = {MAP_GROUP(MAP_PINEVEIL_TOWN), MAP_NUM(MAP_PINEVEIL_TOWN), HEAL_LOCATION_PINEVEIL_TOWN_BRENDANS_HOUSE_2F},
    //[MAPSEC_SYLVARA_TOWN] = {MAP_GROUP(MAP_SYLVARA_TOWN), MAP_NUM(MAP_SYLVARA_TOWN), HEAL_LOCATION_SYLVARA_TOWN},
    ...
    [MAPSEC_STONEREACH_CITY] = {MAP_GROUP(MAP_STONEREACH_CITY), MAP_NUM(MAP_STONEREACH_CITY), HEAL_LOCATION_STONEREACH_CITY},
    ...
    [MAPSEC_ROUTE_4_POKECENTER] = {MAP_GROUP(MAP_ROUTE4), MAP_NUM(MAP_ROUTE4), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_10_POKECENTER] = {MAP_GROUP(MAP_ROUTE10), MAP_NUM(MAP_ROUTE10), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_PINEVEIL_TOWN:
        return FlagGet(FLAG_VISITED_PINEVEIL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SYLVARA_TOWN:
        return FlagGet(FLAG_VISITED_SYLVARA_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_STONEREACH_CITY:
        return FlagGet(FLAG_VISITED_STONEREACH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
{
    {
        ...
        .mapsec = MAPSEC_PINEVEIL_TOWN,
        .flag = FLAG_VISITED_PINEVEIL_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_SYLVARA_TOWN,
        .flag = FLAG_VISITED_SYLVARA_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_STONEREACH_CITY,
        .flag = FLAG_VISITED_STONEREACH_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_PINEVEIL_TOWN:
        return (gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_PINEVEIL_TOWN_BRENDANS_HOUSE : HEAL_LOCATION_PINEVEIL_TOWN_MAYS_HOUSE);
    case MAPSEC_EVER_GRANDE_CITY:
