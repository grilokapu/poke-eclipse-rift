...
#define PSS_DATA_WINDOW_INFO_HEADERS 3
...
#define PSS_DATA_WINDOW_MEMO_NXTLEVEL 2
...
static void PrintInfoHeaders(void);
static void PrintNextLevelTittle(void);
...
static const u8 sText_Cancelar[]                = _("Cancelar");
static const u8 sText_Switch[]                  = _("Switch");
static const u8 sText_Trocar[]                  = _("Trocar");
static const u8 sText_Cambiar[]                 = _("Cambiar");
static const u8 sText_Rename[]                  = _("Rename");
static const u8 sText_Rebautizar[]              = _("Rebautizar");
static const u8 sText_Renomear[]                = _("Renomear");
static const u8 sText_Lv[]                      = _("Lv.");
static const u8 sText_Nv[]                      = _("Nv.");
static const u8 sText_HP_Title[]                = _("HP");
static const u8 sText_PS_Title[]                = _("PS");
static const u8 sText_Attack_Title[]            = _("Attack");
static const u8 sText_Ataque_Title[]            = _("Ataque");
static const u8 sText_Defense_Title[]           = _("Defense");
static const u8 sText_Defesa_Title[]            = _("Defesa");
static const u8 sText_Defensa_Title[]           = _("Defensa");
static const u8 sText_SpAtk_Title[]             = _("Sp. Atk");
static const u8 sText_AtqEsp_Title[]            = _("Atq Esp.");
static const u8 sText_SpDef_Title[]             = _("Sp. Def.");
static const u8 sText_DefEsp_Title[]            = _("Def Esp.");
static const u8 sText_Speed_Title[]             = _("Speed");
static const u8 sText_Veloci_Title[]            = _("Veloci.");
static const u8 sText_ViewIVs[]                 = _("View IV");
static const u8 sText_ViewEVs[]                 = _("View EV");
static const u8 sText_VerIVs[]                  = _("Ver IV");
static const u8 sText_VerEVs[]                  = _("Ver EV");
static const u8 sText_ViewStats[]               = _("View Stats");
static const u8 sText_VerStats[]                = _("Ver Stats");
static const u8 sText_Exp[]                     = _("Exp.");
static const u8 sText_NextLv[]                  = _("Next Lv.");
static const u8 sText_ProxNv[]                  = _("Próx. Nv.");
static const u8 sText_RentalPkmn[]              = _("Rental Pokémon");
static const u8 sText_None[]                    = _("None");
static const u8 sText_Nada[]                    = _("Nada");
static const u8 sText_Egg[]                     = _("Egg");
static const u8 sText_Ovo[]                     = _("Ovo");
static const u8 sText_Huevo[]                   = _("Huevo");
...
static const u8 sText_MemoNaturePt[]            = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} por natureza");
static const u8 sText_MemoNatureEs[]            = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} por naturaleza");
static const u8 sText_MemoMet[]                 = _("Met when it was {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLocation: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoMetPt[]               = _("Encontrado quando era {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLocal: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoMetEs[]               = _("Encontrado cuando era {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLugar: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoHatched[]             = _("Hatched from an egg\nLocation: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoHatchedPt[]           = _("Chocou de um ovo\nLocal: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoHatchedEs[]           = _("Eclosionó de un huevo\nLugar: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoTraded[]              = _("Met in a trade");
static const u8 sText_MemoTradedPt[]            = _("Obtido em troca");
static const u8 sText_MemoTradedEs[]            = _("Obtenido en intercambio");
static const u8 sText_MemoFateful[]             = _("Met in a fateful encounter\nat {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoFatefulPt[]           = _("Encontro especial no {LV_2}.\n{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoFatefulEs[]           = _("Encuentro especial en {LV_2}.\n{DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoProbablyMet[]         = _("Seems to have met at {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLocation: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoProbablyMetPt[]       = _("Parece obtido no Nv. {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLocal: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoProbablyMetEs[]       = _("Parece obtenido en Nv. {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}\nLugar: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}");
static const u8 sText_MemoMetSomewhere[]        = _("Met somewhere at {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoMetSomewherePt[]      = _("Encontrado em algum lugar\nno {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoMetSomewhereEs[]      = _("Encontrado en algún lugar\nen {LV_2}. {DYNAMIC 1}{DYNAMIC 3}{DYNAMIC 1}");
static const u8 sText_MemoHatchedSomewhere[]    = _("Hatched from an egg\nsomewhere.");
static const u8 sText_MemoHatchedSomewherePt[]  = _("Chocou de um ovo\nem algum lugar.");
static const u8 sText_MemoHatchedSomewhereEs[]  = _("Eclosionó de un huevo\nen algún lugar.");
...
//Portuguese
static const u8 sCharacteristic_HP_0_Pt[]    = _("Adora comer");
static const u8 sCharacteristic_HP_1_Pt[]    = _("Tira muitas sonecas");
static const u8 sCharacteristic_HP_2_Pt[]    = _("Dorme com frequência");
static const u8 sCharacteristic_HP_3_Pt[]    = _("Espalha coisas com frequência");
static const u8 sCharacteristic_HP_4_Pt[]    = _("Gosta de relaxar");

static const u8 sCharacteristic_Atk_0_Pt[]   = _("Orgulhoso de sua força");
static const u8 sCharacteristic_Atk_1_Pt[]   = _("Gosta de se debater");
static const u8 sCharacteristic_Atk_2_Pt[]   = _("Um pouco temperamental");
static const u8 sCharacteristic_Atk_3_Pt[]   = _("Gosta de lutar");
static const u8 sCharacteristic_Atk_4_Pt[]   = _("Temperamento forte");

static const u8 sCharacteristic_Def_0_Pt[]   = _("Corpo resistente");
static const u8 sCharacteristic_Def_1_Pt[]   = _("Suporta bem golpes");
static const u8 sCharacteristic_Def_2_Pt[]   = _("Altamente persistente");
static const u8 sCharacteristic_Def_3_Pt[]   = _("Boa resistência");
static const u8 sCharacteristic_Def_4_Pt[]   = _("Boa perseverança");

static const u8 sCharacteristic_Speed_0_Pt[] = _("Gosta de correr");
static const u8 sCharacteristic_Speed_1_Pt[] = _("Atento a sons");
static const u8 sCharacteristic_Speed_2_Pt[] = _("Impulsivo e bobo");
static const u8 sCharacteristic_Speed_3_Pt[] = _("Um tanto brincalhão");
static const u8 sCharacteristic_Speed_4_Pt[] = _("Foge rapidamente");

static const u8 sCharacteristic_SpAtk_0_Pt[] = _("Altamente curioso");
static const u8 sCharacteristic_SpAtk_1_Pt[] = _("Travesso");
static const u8 sCharacteristic_SpAtk_2_Pt[] = _("Muito astuto");
static const u8 sCharacteristic_SpAtk_3_Pt[] = _("Frequentemente pensativo");
static const u8 sCharacteristic_SpAtk_4_Pt[] = _("Muito exigente");

static const u8 sCharacteristic_SpDef_0_Pt[] = _("Vontade forte");
static const u8 sCharacteristic_SpDef_1_Pt[] = _("Um tanto vaidoso");
static const u8 sCharacteristic_SpDef_2_Pt[] = _("Altamente desafiador");
static const u8 sCharacteristic_SpDef_3_Pt[] = _("Odeia perder");
static const u8 sCharacteristic_SpDef_4_Pt[] = _("Um tanto teimoso");

//Spanish

static const u8 sCharacteristic_HP_0_Es[]    = _("Le encanta comer");
static const u8 sCharacteristic_HP_1_Es[]    = _("Duerme muchas siestas");
static const u8 sCharacteristic_HP_2_Es[]    = _("Se duerme con frecuencia");
static const u8 sCharacteristic_HP_3_Es[]    = _("Desordena cosas a menudo");
static const u8 sCharacteristic_HP_4_Es[]    = _("Le gusta relajarse");

static const u8 sCharacteristic_Atk_0_Es[]   = _("Orgulloso de su fuerza");
static const u8 sCharacteristic_Atk_1_Es[]   = _("Le gusta descontrolarse");
static const u8 sCharacteristic_Atk_2_Es[]   = _("Algo temperamental");
static const u8 sCharacteristic_Atk_3_Es[]   = _("Le gusta luchar");
static const u8 sCharacteristic_Atk_4_Es[]   = _("De mal genio");

static const u8 sCharacteristic_Def_0_Es[]   = _("Cuerpo resistente");
static const u8 sCharacteristic_Def_1_Es[]   = _("Soporta bien golpes");
static const u8 sCharacteristic_Def_2_Es[]   = _("Altamente persistente");
static const u8 sCharacteristic_Def_3_Es[]   = _("Buena resistencia");
static const u8 sCharacteristic_Def_4_Es[]   = _("Gran perseverancia");

static const u8 sCharacteristic_Speed_0_Es[] = _("Le gusta correr");
static const u8 sCharacteristic_Speed_1_Es[] = _("Atento a los sonidos");
static const u8 sCharacteristic_Speed_2_Es[] = _("Impulsivo y algo tonto");
static const u8 sCharacteristic_Speed_3_Es[] = _("Un poco payaso");
static const u8 sCharacteristic_Speed_4_Es[] = _("Huye rápidamente");

static const u8 sCharacteristic_SpAtk_0_Es[] = _("Muy curioso");
static const u8 sCharacteristic_SpAtk_1_Es[] = _("Travieso");
static const u8 sCharacteristic_SpAtk_2_Es[] = _("Muy astuto");
static const u8 sCharacteristic_SpAtk_3_Es[] = _("Suele estar pensativo");
static const u8 sCharacteristic_SpAtk_4_Es[] = _("Muy exigente");

static const u8 sCharacteristic_SpDef_0_Es[] = _("De fuerte voluntad");
static const u8 sCharacteristic_SpDef_1_Es[] = _("Algo vanidoso");
static const u8 sCharacteristic_SpDef_2_Es[] = _("Muy desafiante");
static const u8 sCharacteristic_SpDef_3_Es[] = _("Odia perder");
static const u8 sCharacteristic_SpDef_4_Es[] = _("Algo terco");

//Headers
static const u8 gText_PSS_Nome[] = _("Nome");
static const u8 gText_PSS_Tipo[] = _("Tipo");
static const u8 gText_PSS_Dono[] = _("Dono");
static const u8 gText_PSS_Natureza[] = _("Natureza");
static const u8 gText_PSS_Nombre[] = _("Nombre");
static const u8 gText_PSS_Dueño[] = _("Dueño");
static const u8 gText_PSS_Name[] = _("Name");
static const u8 gText_PSS_Type[] = _("Type");
static const u8 gText_PSS_OT[] = _("OT");
static const u8 gText_PSS_Nature[] = _("Nature");
...
static const u8 *const sMonCharacteristicTablePt[MON_CHARACTERISTIC_COUNT] = {
    // HP
    sCharacteristic_HP_0_Pt,
    sCharacteristic_HP_1_Pt,
    sCharacteristic_HP_2_Pt,
    sCharacteristic_HP_3_Pt,
    sCharacteristic_HP_4_Pt,
    // Attack
    sCharacteristic_Atk_0_Pt,
    sCharacteristic_Atk_1_Pt,
    sCharacteristic_Atk_2_Pt,
    sCharacteristic_Atk_3_Pt,
    sCharacteristic_Atk_4_Pt,
    // Defense
    sCharacteristic_Def_0_Pt,
    sCharacteristic_Def_1_Pt,
    sCharacteristic_Def_2_Pt,
    sCharacteristic_Def_3_Pt,
    sCharacteristic_Def_4_Pt,
    // Speed
    sCharacteristic_Speed_0_Pt,
    sCharacteristic_Speed_1_Pt,
    sCharacteristic_Speed_2_Pt,
    sCharacteristic_Speed_3_Pt,
    sCharacteristic_Speed_4_Pt,
    // Sp. Atk
    sCharacteristic_SpAtk_0_Pt,
    sCharacteristic_SpAtk_1_Pt,
    sCharacteristic_SpAtk_2_Pt,
    sCharacteristic_SpAtk_3_Pt,
    sCharacteristic_SpAtk_4_Pt,
    // Sp. Def
    sCharacteristic_SpDef_0_Pt,
    sCharacteristic_SpDef_1_Pt,
    sCharacteristic_SpDef_2_Pt,
    sCharacteristic_SpDef_3_Pt,
    sCharacteristic_SpDef_4_Pt,
};

static const u8 *const sMonCharacteristicTableEs[MON_CHARACTERISTIC_COUNT] = {
    // HP
    sCharacteristic_HP_0_Es,
    sCharacteristic_HP_1_Es,
    sCharacteristic_HP_2_Es,
    sCharacteristic_HP_3_Es,
    sCharacteristic_HP_4_Es,
    // Attack
    sCharacteristic_Atk_0_Es,
    sCharacteristic_Atk_1_Es,
    sCharacteristic_Atk_2_Es,
    sCharacteristic_Atk_3_Es,
    sCharacteristic_Atk_4_Es,
    // Defense
    sCharacteristic_Def_0_Es,
    sCharacteristic_Def_1_Es,
    sCharacteristic_Def_2_Es,
    sCharacteristic_Def_3_Es,
    sCharacteristic_Def_4_Es,
    // Speed
    sCharacteristic_Speed_0_Es,
    sCharacteristic_Speed_1_Es,
    sCharacteristic_Speed_2_Es,
    sCharacteristic_Speed_3_Es,
    sCharacteristic_Speed_4_Es,
    // Sp. Atk
    sCharacteristic_SpAtk_0_Es,
    sCharacteristic_SpAtk_1_Es,
    sCharacteristic_SpAtk_2_Es,
    sCharacteristic_SpAtk_3_Es,
    sCharacteristic_SpAtk_4_Es,
    // Sp. Def
    sCharacteristic_SpDef_0_Es,
    sCharacteristic_SpDef_1_Es,
    sCharacteristic_SpDef_2_Es,
    sCharacteristic_SpDef_3_Es,
    sCharacteristic_SpDef_4_Es,
};
...
static const u8 sButtons_Gfx[][4 * TILE_SIZE_4BPP] = {
    ...
    static const u32 sMoveTypesPt_Gfx[] = INCBIN_U32("graphics/summary_screen/swsh/move_types_pt.4bpp.smol");
    static const u32 sMoveTypesEs_Gfx[] = INCBIN_U32("graphics/summary_screen/swsh/move_types_es.4bpp.smol");
...
static const struct CompressedSpriteSheet sSpriteSheet_MoveTypesPt =
{
    .data = sMoveTypesPt_Gfx,
    .size = (NUMBER_OF_MON_TYPES) * 0x100,
    .tag = TAG_MOVE_TYPES
};

static const struct CompressedSpriteSheet sSpriteSheet_MoveTypesEs =
{
    .data = sMoveTypesEs_Gfx,
    .size = (NUMBER_OF_MON_TYPES) * 0x100,
    .tag = TAG_MOVE_TYPES
};
...
static bool8 LoadMoveTypesIconGfx(void)
{
    if (language == PT)
        return LoadCompressedSpriteSheet(&sSpriteSheet_MoveTypesPt);
    else if (language == ES)
        return LoadCompressedSpriteSheet(&sSpriteSheet_MoveTypesEs);
    else
        return LoadCompressedSpriteSheet(&sSpriteSheet_MoveTypes);
}
...
static void PrintNotEggInfo(void)
{
    ...
    if (statusAnim == 0)
    {
        ...
        PrintTextOnWindowWithFont(PSS_LABEL_WINDOW_PORTRAIT_INFO, lvl, 74, 1, 0, 1, FONT_SMALL_NARROWER);
...
static void PrintPageNamesAndStats(void)
{
    ...
    if (language == PT)
    {
        txtswitch = sText_Trocar;
        viewevs = sText_VerEVs;
        viewivs = sText_VerIVs;
        viewstats = sText_VerStats;
    }
    else if (language == ES)
    {
        txtswitch = sText_Cambiar;
        viewevs = sText_VerEVs;
        viewivs = sText_VerIVs;
        viewstats = sText_VerStats;
    }
    ...
    {
        txtswitch = sText_Switch;
        viewevs = sText_ViewEVs;
        viewivs = sText_ViewIVs;
        viewstats = sText_ViewStats;
    }

    stringXPos = GetStringRightAlignXOffset(FONT_SHORT_NARROW, txtswitch, 62) - 2;
    iconXPos = stringXPos - 11;
    if (iconXPos < 0)
        iconXPos = 0;
    PrintButtonIcon(PSS_LABEL_WINDOW_PROMPT_SWITCH, BUTTON_A, iconXPos, 4);
    PrintTextOnWindowWithFont(PSS_LABEL_WINDOW_PROMPT_SWITCH, txtswitch, stringXPos, 0, 0, 0, FONT_SMALL);

    if (SWSH_SUMMARY_SHOW_IV_EV)
    {
        stringXPos = GetStringRightAlignXOffset(FONT_SHORT_NARROW, viewivs, skillsLabelWidth) - 2;
        iconXPos = stringXPos - 11;
        if (iconXPos < 0)
            iconXPos = 0;
        PrintButtonIcon(PSS_LABEL_WINDOW_PROMPT_IVS, BUTTON_A, iconXPos, 4);
        PrintTextOnWindowWithFont(PSS_LABEL_WINDOW_PROMPT_IVS, viewivs, stringXPos, 0, 0, 1, FONT_SMALL);

        stringXPos = GetStringRightAlignXOffset(FONT_SHORT_NARROW, viewevs, skillsLabelWidth) - 2;
        iconXPos = stringXPos - 11;
        if (iconXPos < 0)
            iconXPos = 0;
        PrintButtonIcon(PSS_LABEL_WINDOW_PROMPT_EVS, BUTTON_A, iconXPos, 4);
        PrintTextOnWindowWithFont(PSS_LABEL_WINDOW_PROMPT_EVS, viewevs, stringXPos, 0, 0, 1, FONT_SMALL);

        stringXPos = GetStringRightAlignXOffset(FONT_SHORT_NARROW, viewstats, skillsLabelWidth) - 2;
        iconXPos = stringXPos - 11;
        if (iconXPos < 0)
            iconXPos = 0;
        PrintButtonIcon(PSS_LABEL_WINDOW_PROMPT_STATS, BUTTON_A, iconXPos, 4);
        PrintTextOnWindowWithFont(PSS_LABEL_WINDOW_PROMPT_STATS, viewstats, stringXPos, 0, 0, 1, FONT_SMALL);
    }
...
static void PrintInfoHeaders(void)
{
    ...
    windowId = AddWindowFromTemplateList(sPageInfoTemplate, PSS_DATA_WINDOW_INFO_HEADERS);

    if (language == PT)
    {
        name = gText_PSS_Nome;
        type = gText_PSS_Tipo;
        otName = gText_PSS_Dono;
        Nature = gText_PSS_Natureza;
        x = 14;
        x2 = 14;
        x3 = 14;
        x4 = 5;
    ...
    {
        name = gText_PSS_Nombre;
        type = gText_PSS_Tipo;
        otName = gText_PSS_Dueño;
        Nature = gText_PSS_Nature;
        x = 11;
        x2 = 14;
        x3 = 11;
        x4 = 10;
    ...
    PrintTextOnWindow(windowId, name, x, 3, 0, LIGHT_GRAY);
    PrintTextOnWindow(windowId, type, x2, 20, 0, LIGHT_GRAY);
    PrintTextOnWindow(windowId, otName, x3, 37, 0, LIGHT_GRAY);
    PrintTextOnWindow(windowId, Nature, x4, 54, 0, LIGHT_GRAY);
}
...
static void PrintMonAbilityName(void)
{
    ...
    if (language == PT)
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), gAbilitiesInfo[ability].nome, 48, y, 0, 0);
    else if (language == ES)
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), gAbilitiesInfo[ability].nombre, 48, y, 0, 0);
    else
...
static void PrintMonAbilityDescription(void)
{
    ...
    if (language == PT)
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), gAbilitiesInfo[ability].descricao, 0, y, 0, 0);
    else if (language == ES)
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), gAbilitiesInfo[ability].descripcion, 0, y, 0, 0);
    else
...
static const u8 *GetCharacteristicString(void)
{
    ...
    if (language == PT) {
        return sMonCharacteristicTablePt[index];
    }
    else if (language == ES) {
        return sMonCharacteristicTableEs[index];
    }
    else {
...
static void BufferNatureString(u8 useMint)
{
    ...
    if (language == PT) {
        mint = gNaturesInfo[sum->mintNature].nome;
        nature = gNaturesInfo[sum->nature].nome;
    }
    else if (language == ES) {
        mint = gNaturesInfo[sum->mintNature].nombre;
        nature = gNaturesInfo[sum->nature].nombre;
    }
    else {
        mint = gNaturesInfo[sum->mintNature].nome;
        nature = gNaturesInfo[sum->nature].name;
    }

    DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, sMemoNatureTextColor);
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(1, sMemoMiscTextColor);
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(2, useMint ? mint : nature);
...
static void BufferMonNatureMemo(void)
{
    ...
    if (language == PT)
        memonature = sText_MemoNaturePt;
    else if (language == ES)
        memonature = sText_MemoNatureEs;
    else
        memonature = sText_MemoNature;
    BufferNatureString(0);
    DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, memonature);
}
...
static void BufferMonEncounter(void)
{
    ...
    const u8* memomet;
    const u8* memometsomewhere;
    const u8* memotraded;
    const u8* memofateful;
    const u8* memoprobmet;
    const u8* memoharched;
    const u8* memoharchedsome;
    ...
    if (language == PT) {
        text = sText_MemoNaturePt;
        memomet = sText_MemoMetPt;
        memometsomewhere = sText_MemoMetSomewherePt;
        memotraded = sText_MemoTradedPt;
        memofateful = sText_MemoFatefulPt;
        memoprobmet = sText_MemoProbablyMetPt;
        memoharched = sText_MemoHatchedPt;
        memoharchedsome = sText_MemoHatchedSomewherePt;
    }
    else if (language == ES) {
        text = sText_MemoNatureEs;
        memomet = sText_MemoMetEs;
        memometsomewhere = sText_MemoMetSomewhereEs;
        memotraded = sText_MemoTradedEs;
        memofateful = sText_MemoFatefulEs;
        memoprobmet = sText_MemoProbablyMetEs;
        memoharched = sText_MemoHatchedEs;
        memoharchedsome = sText_MemoHatchedSomewhereEs;
    }
    else {
        text = sText_MemoNature;
        memomet = sText_MemoMet;
        memometsomewhere = sText_MemoMetSomewhere;
        memotraded = sText_MemoTraded;
        memofateful = sText_MemoFateful;
        memoprobmet = sText_MemoProbablyMet;
        memoharched = sText_MemoHatched;
        memoharchedsome = sText_MemoHatchedSomewhere;
    }

    if (DoesMonOTMatchOwner() == TRUE) 
    {
        if (sum->metLevel == 0)
            text = (!locationFound) ? memoharchedsome : memoharched;
        else
            text = (!locationFound) ? memometsomewhere : memomet;
    }
    ...
    {
        text = (!locationFound) ? memotraded : memoprobmet;
    }
    else
    {
        text = memotraded;
...
static void PrintStatLabels(void)
{
    ...
    const u8* atk_tittle;
    const u8* def_tittle;
    const u8* spatk_tittle;
    const u8* spdef_tittle;
    const u8* speed_tittle;

    if (language == PT)
    {
        hp_tittle = sText_PS_Title;
        atk_tittle = sText_Ataque_Title;
        def_tittle = sText_Defesa_Title;
        spatk_tittle = sText_AtqEsp_Title;
        spdef_tittle = sText_DefEsp_Title;
        speed_tittle = sText_Veloci_Title;
    }
    else if (language == ES)
    {
        hp_tittle = sText_PS_Title;
        atk_tittle = sText_Ataque_Title;
        def_tittle = sText_Defensa_Title;
        spatk_tittle = sText_AtqEsp_Title;
        spdef_tittle = sText_DefEsp_Title;
        speed_tittle = sText_Veloci_Title;
    }
    ...
    {
        hp_tittle = sText_HP_Title;
        atk_tittle = sText_Attack_Title;
        def_tittle = sText_Defense_Title;
        spatk_tittle = sText_SpAtk_Title;
        spdef_tittle = sText_SpDef_Title;
        speed_tittle = sText_Speed_Title;
    }

    // Print HP label
    PrintTextOnWindow(windowId, hp_tittle, 8, 2, 0, 0);
    
    // Print non-HP stat labels (colored)
    PrintColoredStatLabel(windowId, STAT_ATK, atk_tittle, 80, 2, natureUpStat, natureDownStat, coloredLabel);
    PrintColoredStatLabel(windowId, STAT_DEF, def_tittle, 8, 19, natureUpStat, natureDownStat, coloredLabel);
    PrintColoredStatLabel(windowId, STAT_SPATK, spatk_tittle, 80, 19, natureUpStat, natureDownStat, coloredLabel);
    PrintColoredStatLabel(windowId, STAT_SPDEF, spdef_tittle, 8, 36, natureUpStat, natureDownStat, coloredLabel);
    PrintColoredStatLabel(windowId, STAT_SPEED, speed_tittle, 80, 36, natureUpStat, natureDownStat, coloredLabel);
}

static void PrintNextLevelTittle(void)
{
    u8 windowId = AddWindowFromTemplateList(sPageMemoTemplate, PSS_DATA_WINDOW_MEMO_NXTLEVEL);
    const u8* nxtlevel;

    if (language == PT || language == ES)
        nxtlevel = sText_ProxNv;
    else
        nxtlevel = sText_NextLv;

    PrintTextOnWindow(windowId, nxtlevel, 8, 21, 0, LIGHT_GRAY);
}
        ...
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES)
        {
            ...
            if (SWSH_SUMMARY_AUTO_FORMAT_MOVE_DESCRIPTIONS)
            {
                ...
                if (gMovesInfo[move].effect != EFFECT_PLACEHOLDER)
                    if (language == PT)
                        descFontId = FormatTextByWidth(desc, 136, FONT_SHORT_NARROW, gMovesInfo[move].descriptionPt, GetFontAttribute(FONT_SHORT_NARROW, FONTATTR_LETTER_SPACING));
                    else if (language == ES)
                        descFontId = FormatTextByWidth(desc, 136, FONT_SHORT_NARROW, gMovesInfo[move].descriptionEs, GetFontAttribute(FONT_SHORT_NARROW, FONTATTR_LETTER_SPACING));
                    else
            ...
            else
            {
                if (gMovesInfo[move].effect != EFFECT_PLACEHOLDER)
                    if (language == PT)
                        PrintTextOnWindow(windowId, gMovesInfo[move].descriptionPt, 0, 4, 1, 0);
                    else if (language == ES)
                        PrintTextOnWindow(windowId, gMovesInfo[move].descriptionEs, 0, 4, 1, 0);
                    else
...
static void PrintNewMoveDetailsOrCancelText(void)
{
    ...
    if (sMonSummaryScreen->newMove == MOVE_NONE)
    {
        ...
        PrintTextOnWindowWithFont(windowId1, cancel, 4, 4 * 18 + 4, 0, 5, FONT_SMALL);
    }
    else
    {
...
static void ShowCancelOrRenamePrompt(void)
{
    ...
    {
        cancel = sText_Cancelar;
        rename = sText_Renomear;
    }
    else if (language == ES)
    {
        cancel = sText_Cancelar;
        rename = sText_Rebautizar;
    }
    else
    {
        cancel = sText_Cancel;
    ...
    const u8 *promptText = ShouldShowRename() ? rename : cancel;
