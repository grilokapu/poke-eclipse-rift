...
enum {
    ...
    WIN_APP_JAM_LABEL,
#endif
#if SWSH_ITEM_MENU_BERRY_STAT == TRUE
    WIN_BERRY_INFO,
    WIN_BERRY_FLAVORS,
#endif
#if SWSH_ITEM_MENU_IN_BAG_USE == TRUE
...
#if SWSH_ITEM_MENU_BERRY_TAG == TRUE
...
#if SWSH_ITEM_MENU_PYRAMID == TRUE
...
static const u8 sRegisteredSelect_Gfx[]         = INCBIN_U8("graphics/bag/swsh/select_button.4bpp");
static const u32 sBagScreen_Gfx[]               = INCBIN_U32("graphics/bag/swsh/tiles.4bpp.smol");
static const u16 sBagScreen_Pal[]               = INCBIN_U16("graphics/bag/swsh/tiles.gbapal");
static const u32 sBagScreen_BG2TileMap[]        = INCBIN_U32("graphics/bag/swsh/bg2.bin.smolTM");
static const u32 sBagScreen_BG3TileMap[]        = INCBIN_U32("graphics/bag/swsh/bg3.bin.smolTM");
static const u32 sCursor_Gfx[]                  = INCBIN_U32("graphics/bag/swsh/cursor.4bpp.smol");
static const u32 sHoverSlot_Gfx[]               = INCBIN_U32("graphics/bag/swsh/hover_slot.4bpp.smol");
static const u32 sScrollThumb_Gfx[]             = INCBIN_U32("graphics/bag/swsh/scroll_thumb.4bpp.smol");
static const u32 sCategoryIcons_Gfx[]           = INCBIN_U32("graphics/bag/swsh/category_icons.4bpp.smol");
static const u32 sPocketScrollArrows_Gfx[]      = INCBIN_U32("graphics/bag/swsh/pocket_scroll_arrows.4bpp.smol");
static const u32 sSwapCursor_Gfx[]              = INCBIN_U32("graphics/bag/swsh/swap_cursor.4bpp.smol");
static const u32 sFrameMoney_Gfx[]              = INCBIN_U32("graphics/bag/swsh/frame_money.4bpp.smol");
static const u32 sFramePriceQuantity_Gfx[]      = INCBIN_U32("graphics/bag/swsh/frame_price_quantity.4bpp.smol");
static const u8 sBagMenuHMIcon_Gfx[]            = INCBIN_U8("graphics/bag/swsh/hm.4bpp");
static const u16 sCursor_Pal[]                  = INCBIN_U16("graphics/bag/swsh/cursor.gbapal");
static const u32 sMoveTypeIcons_Gfx[]           = INCBIN_U32("graphics/bag/swsh/move_types.4bpp.smol");
static const u16 sMoveTypeIcons_Pal[]           = INCBIN_U16("graphics/bag/swsh/move_types.gbapal");
...
static const u32 sStatusIcons_Gfx[]             = INCBIN_U32("graphics/bag/swsh/status_icons.4bpp.smol");
#if SWSH_ITEM_MENU_IN_BATTLE_USE == TRUE
static const u32 sMultiBattleSwapPrompt_Gfx[]   = INCBIN_U32("graphics/bag/swsh/prompt_swap.4bpp.smol");
#endif
#endif
...
#if SWSH_ITEM_MENU_IN_BAG_USE == TRUE && SWSH_ITEM_MENU_IN_BATTLE_USE
...
static void OpenContextMenu(u8 taskId)
{
    ...
    case ITEMMENULOCATION_QUIZ_LADY:
        if ((!GetItemImportance(gSpecialVar_ItemId) && gSpecialVar_ItemId != ITEM_ENIGMA_BERRY_E_READER)
         || (gSpecialVar_ItemId >= ITEM_HELIX_FOSSIL && gSpecialVar_ItemId <= ITEM_FOSSILIZED_DINO))
        {
...
static void ItemMenu_Give(u8 taskId)
{
    ...
    else if (!GetItemImportance(gSpecialVar_ItemId))
    {
        ...
        {
#if SWSH_ITEM_MENU_IN_BAG_USE == TRUE
#if SWSH_ITEM_MENU_PYRAMID == TRUE && !SWSH_ITEM_MENU_PYRAMID_ACTION
            if (gBagPosition.isPyramid)
            {
...
static void BagMenu_UseMedicine(u8 taskId)
{
    ...
    else
    {
        ...
        cannotUse = ExecuteTableBasedItemEffect(mon, item, tPartySlot, 0, 1, 1);
    }
    ...
    for (s16 i = 1; i < tItemCount; i++)
        ExecuteTableBasedItemEffect(mon, item, tPartySlot, 0, 1, 1);
...
static void BagMenu_UseRareCandy(u8 taskId)
{
    ...
    else
    {
        ...
        {
            if (!ExecuteTableBasedItemEffect(mon, item, tPartySlot, 0, 1, 1))
                appliedCount++;
            else
                break;
        }
...
static void Task_BagMenu_FormChangeAnim(u8 taskId)
{
    ...
    case 1:
        if (tAnimFrame == 0)
        {
            u16 newSpecies = (u16)tAnimSpecies;
...
static const u8 gText_LightBulb[] = _("Light bulb");
static const u8 gText_Microwave[] = _("Microwave oven");
static const u8 gText_WashingMachine[] = _("Washing machine");
static const u8 gText_Refrigerator[] = _("Refrigerator");
static const u8 gText_ElectricFan[] = _("Electric fan");
static const u8 gText_LawnMower[] = _("Lawn mower");
...
static const u8 gText_ChangeForm[] = _("Change form");
static const u8 gText_ChangeAbility[] = _("Change ability");
...
static bool8 BagMenu_IsMultiFull(void)
{
    return BagMenu_InBattleSelect() && IsMultiBattle() == TRUE && AreMultiPartiesFullTeams();
}
