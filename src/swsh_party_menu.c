...
static EWRAM_DATA u16 sFusionFirstMonSpecies = SPECIES_NONE; // Fusion item: selected first mon species
...
static void DeleteInvalidFusionMoves(struct Pokemon *mon, u16 species)
{
    for (u32 i = 0; i < MAX_MON_MOVES; i++)
    {
