...
#define PSS_DATA_WINDOW_SKILLS_STATS_NAMES 6
...
#define PSS_DATA_WINDOW_CONTEST_APPEAL_JAM 2
...
static void PrintContestAppealJamLabels(void);
...
extern bool32 HasAnyRelearnableMoves(enum MoveRelearnerStates state);
static void PrintStatsNames(void);
static void GetNatureTextColor(u8 *color, s8 statIndex);
static void PokeSum_CreateMonIcon(void);
static void PokeSum_ShowOrHideMonIconSprite(bool8 invisible);

//strings
const u8 gText_PSS_Name_En[] = _("Name");
const u8 gText_PSS_Name_Pt[] = _("Nome");
const u8 gText_PSS_Name_Es[] = _("Nombre");
const u8 gText_PSS_DexNumber_En[] = _("No.");
const u8 gText_PSS_DexNumber_Pt[] = _("No.");
const u8 gText_PSS_DexNumber_Es[] = _("No.");
const u8 gText_PSS_Type_En[] = _("Type");
const u8 gText_PSS_Type_Pt[] = _("Tipo");
const u8 gText_PSS_Type_Es[] = _("Tipo");
const u8 gText_PSS_OTName_En[] = _("OT");
const u8 gText_PSS_OTName_Pt[] = _("OT");
const u8 gText_PSS_OTName_Es[] = _("OT");
const u8 gText_PSS_OTID_En[] = _("ID No.");
const u8 gText_PSS_OTID_Pt[] = _("No. ID");
const u8 gText_PSS_OTID_Es[] = _("No. ID");
const u8 gText_PSS_Item_En[] = _("Item");
const u8 gText_PSS_Item_Pt[] = _("Item");
const u8 gText_PSS_Item_Es[] = _("Objeto");
const u8 gText_PSS_Hp_En[] = _("HP");
const u8 gText_PSS_Hp_Pt[] = _("HP");
const u8 gText_PSS_Hp_Es[] = _("HP");
const u8 gText_PSS_Atk_En[] = _("Attack");
const u8 gText_PSS_Atk_Pt[] = _("Ataque");
const u8 gText_PSS_Atk_Es[] = _("Ataque");
const u8 gText_PSS_Def_En[] = _("Defense");
const u8 gText_PSS_Def_Pt[] = _("Defesa");
const u8 gText_PSS_Def_Es[] = _("Defensa");
const u8 gText_PSS_Spa_En[] = _("Sp.Atk");
const u8 gText_PSS_Spa_Pt[] = _("Atq.Esp");
const u8 gText_PSS_Spa_Es[] = _("At.Esp");
const u8 gText_PSS_Spd_En[] = _("Sp.Def");
const u8 gText_PSS_Spd_Pt[] = _("Def.Esp");
const u8 gText_PSS_Spd_Es[] = _("Def.Esp");
const u8 gText_PSS_Spe_En[] = _("Speed");
const u8 gText_PSS_Spe_Pt[] = _("Veloc.");
const u8 gText_PSS_Spe_Es[] = _("Veloc.");
const u8 gText_PSS_Power_En[] = _("Power");
const u8 gText_PSS_Power_Pt[] = _("Poder");
const u8 gText_PSS_Power_Es[] = _("Poder");
const u8 gText_PSS_Accuracy_En[] = _("Accuracy");
const u8 gText_PSS_Accuracy_Pt[] = _("Precisão");
const u8 gText_PSS_Accuracy_Es[] = _("Precision");
const u8 gText_PSS_Appeal_En[] = _("Appeal");
const u8 gText_PSS_Appeal_Pt[] = _("Apelo");
const u8 gText_PSS_Appeal_Es[] = _("Atract.");
const u8 gText_PSS_Jam_En[] = _("Jam");
const u8 gText_PSS_Jam_Pt[] = _("Trava");
const u8 gText_PSS_Jam_Es[] = _("Molest.");
...
// bg gfx
#if BW_SUMMARY_SCREEN_SWSH_GRAPHICS == FALSE
...
#else
const u32 sSummaryScreen_Gfx_BW[]                           = INCBIN_U32("graphics/summary_screen/bw/tiles2.4bpp.smol");
const u16 sSummaryScreen_Pal_BW[]                           = INCBIN_U16("graphics/summary_screen/bw/tiles2.gbapal");
const u32 sSummaryPage_Info_Tilemap_BW[]                    = INCBIN_U32("graphics/summary_screen/bw/sw_page_info.bin.smolTM");
const u32 sSummaryPage_Skills_Tilemap_BW[]                  = INCBIN_U32("graphics/summary_screen/bw/sw_page_skills.bin.smolTM");
const u32 sSummaryPage_BattleMoves_Tilemap_BW[]             = INCBIN_U32("graphics/summary_screen/bw/sw_page_moves.bin.smolTM");
const u32 sSummaryPage_ContestMoves_Tilemap_BW[]            = INCBIN_U32("graphics/summary_screen/bw/sw_page_contest.bin.smolTM");
const u32 sSummaryEffect_Battle_Tilemap_BW[]                = INCBIN_U32("graphics/summary_screen/bw/sw_effect_battle.bin.smolTM");
const u32 sSummaryEffect_Contest_Tilemap_BW[]               = INCBIN_U32("graphics/summary_screen/bw/sw_effect_contest.bin.smolTM");
const u32 sSummaryPage_ScrollBG_Tilemap_BW[]                = INCBIN_U32("graphics/summary_screen/bw/sw_scroll_bg.bin.smolTM");
#endif
...
static const struct WindowTemplate sPageMovesTemplate[] = // This is used for both battle and contest moves
{
    ...
    [PSS_DATA_WINDOW_CONTEST_APPEAL_JAM] = {
        .bg = 0,
        .tilemapLeft = 15,
        .tilemapTop = 7,
        .width = 8,
    ...
    if (BW_SUMMARY_BG_BLEND || BW_SUMMARY_MON_SHADOWS)
    {
        if (BW_SUMMARY_BG_BLEND)
            SetGpuReg(REG_OFFSET_BLDCNT,
                BLDCNT_TGT2_BG3 | BLDCNT_TGT2_BG2 |
                BLDCNT_EFFECT_BLEND |
                BLDCNT_TGT1_BG2 | BLDCNT_TGT1_BG1);
        else
            SetGpuReg(REG_OFFSET_BLDCNT,
                BLDCNT_TGT2_BG3 | BLDCNT_TGT2_BG2 |
                BLDCNT_EFFECT_BLEND);
        #if BW_SUMMARY_SCREEN_SWSH_GRAPHICS == TRUE
        SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(16, 1));
        #else
...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    default:
        ...
        sMonSummaryScreen->relearnableMovesNum = HasAnyRelearnableMoves(MOVE_RELEARNER_LEVEL_UP_MOVES);
        return TRUE;
    }
    sMonSummaryScreen->switchCounter++;
    return FALSE;
...
#define TILEMAP_APPEAL_ROW_START    0x115
#define TILEMAP_JAM_ROW_1_START     0x135
#define TILEMAP_JAM_ROW_2_START     0x155

#define TILE_EMPTY_HEART_TOP        0x010D
#define TILE_EMPTY_HEART_MIDDLE     0x010E
#define TILE_EMPTY_HEART_BOTTOM     0x010F

#define TILE_APPEAL_HEART_TOP       0x4107

#define TILE_JAM_HEART_MIDDLE       0x4108
#define TILE_JAM_HEART_BOTTOM       0x410A
...
#define HP_BAR_TILE_EMPTY_ROW_1    0x1120
#define HP_BAR_TILE_FULL_ROW_1     0x1128
#define HP_BAR_TILE_EMPTY_ROW_2    0x1130
#define HP_BAR_TILE_FULL_ROW_2     0x1138
...
#define EXP_BAR_TILEMAP_START 0x1F3
#define EXP_BAR_TILE_EMPTY    0x2140
#define EXP_BAR_TILE_FULL     0x2148
...
static void PrintNotEggInfo(void)
{
    ...
    PrintTextOnWindowToFitPx(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL, gStringVar1, 17, 2, 0, 0, WindowWidthPx(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL) - 9);
    ...
    PrintTextOnWindow(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL, gStringVar1, 17, 14, 0, 0);
...
static void PrintEggInfo(void)
{
    ...
    PrintTextOnWindow(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL, gStringVar1, 17, 2, 0, 0);
    PutWindowTilemap(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL);
}
...
static void PrintGenderSymbol(struct Pokemon *mon, u16 species)
{
    if (species != SPECIES_NIDORAN_M && species != SPECIES_NIDORAN_F)
    {
        ...
        {
        case MON_MALE:
            PrintTextOnWindow(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL, gText_MaleSymbol, 72, 1, 0, 3);
            break;
        case MON_FEMALE:
            PrintTextOnWindow(PSS_LABEL_WINDOW_PORTRAIT_NICKNAME_GENDER_LEVEL, gText_FemaleSymbol, 72, 1, 0, 4);
            break;
        }
    }
}
...
static void PrintInfoHeaders(void)
{
    ...
    if (GET_LANGUAGE() == PT)
    {
        dexNumber = gText_PSS_DexNumber_Pt;
        name = gText_PSS_Name_Pt;
        type = gText_PSS_Type_Pt;
        otName = gText_PSS_OTName_Pt;
        otId = gText_PSS_OTID_Pt;
        item = gText_PSS_Item_Pt;
    }
    else if (GET_LANGUAGE() == ES)
    {
        dexNumber = gText_PSS_DexNumber_Es;
        name = gText_PSS_Name_Es;
        type = gText_PSS_Type_Es;
        otName = gText_PSS_OTName_Es;
        otId = gText_PSS_OTID_Es;
        item = gText_PSS_Item_Es;
    }
    else if (GET_LANGUAGE() == EN)
    {
        dexNumber = gText_PSS_DexNumber_En;
        name = gText_PSS_Name_En;
        type = gText_PSS_Type_En;
        otName = gText_PSS_OTName_En;
        otId = gText_PSS_OTID_En;
        item = gText_PSS_Item_En;
    }
    else
    {
        dexNumber = gText_PSS_DexNumber_En;
    ...
    PrintTextOnWindowWithFont(windowId, dexNumber, 0, 0, 0, 13, 2);
    PrintTextOnWindowWithFont(windowId, name, 0, 12, 0, 13, 2);
    PrintTextOnWindowWithFont(windowId, type, 0, 24, 0, 13, 2);
    PrintTextOnWindowWithFont(windowId, otName, 0, 36, 0, 13, 2);
    PrintTextOnWindowWithFont(windowId, otId, 0, 48, 0, 13, 2);
    PrintTextOnWindowWithFont(windowId, item, 0, 60, 0, 13, 2);
}
...
static void PrintMonDexNumberSpecies(void)
{
    ...
    {
        PrintTextOnWindowToFitPx(windowId, GetSpeciesName(summary->species2), 52, 12, 0, 0, WindowWidthPx(windowId) - 9);
        ...
        if (dexNum != 0xFFFF)
        {
            ...
            if (!IsMonShiny(mon))
            {
                PrintTextOnWindow(windowId, gStringVar1, 52, 0, 0, 0);
                HandleMonShinyIcon(FALSE);
            }
            else
            {
                PrintTextOnWindow(windowId, gStringVar1, 52, 0, 0, 6);
...
static void PrintMonAbilityName(void)
{
    ...
    PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), GetAbilityName(ability), 4, 2, 0, 0);
}
...
static void PrintStatsNames(void)
{
    ...
    windowId = AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_STATS_NON_HP);

    if (GET_LANGUAGE() == PT)
    {
        hp = gText_PSS_Hp_Pt;
        atk = gText_PSS_Atk_Pt;
        def = gText_PSS_Def_Pt;
        spa = gText_PSS_Spa_Pt;
        spd = gText_PSS_Spd_Pt;
        spe = gText_PSS_Spe_Pt;
    }
    else if (GET_LANGUAGE() == ES)
    {
        hp = gText_PSS_Hp_Es;
        atk = gText_PSS_Atk_Es;
        def = gText_PSS_Def_Es;
        spa = gText_PSS_Spa_Es;
        spd = gText_PSS_Spd_Es;
        spe = gText_PSS_Spe_Es;
    }
    else if (GET_LANGUAGE() == EN)
    {
        hp = gText_PSS_Hp_En;
        atk = gText_PSS_Atk_En;
        def = gText_PSS_Def_En;
        spa = gText_PSS_Spa_En;
        spd = gText_PSS_Spd_En;
        spe = gText_PSS_Spe_En;
    }
    else
    {
        hp = gText_PSS_Hp_En;
    ...
    GetNatureTextColor(color, 0);
    AddTextPrinterParameterized3(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_STATS_HP), FONT_SHORT, 4, 0, color, 0, hp);

    GetNatureTextColor(color, STAT_ATK);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 4, 4, color, 0, atk);

    GetNatureTextColor(color, STAT_DEF);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 4, 16, color, 0, def);

    GetNatureTextColor(color, STAT_SPATK);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 4, 28, color, 0, spa);

    GetNatureTextColor(color, STAT_SPDEF);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 4, 40, color, 0, spd);

    GetNatureTextColor(color, STAT_SPEED);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 4, 52, color, 0, spe);
}

static void PrintMonAbilityDescription(void)
{
    u16 ability = GetAbilityBySpecies(sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.abilityNum);
    PrintTextOnWindow_BW_Font(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_ABILITY), GetAbilityDescription(ability), 4, 15, 0, 0);
}
...
static void PrintMonTrainerMemo(void)
{
    PrintTextOnWindow_BW_Font(AddWindowFromTemplateList(sPageInfoTemplate, PSS_DATA_WINDOW_INFO_MEMO), gStringVar4, 16, 8, 0, 0);
}
...
{
    if (mode == SKILL_STATE_STATS)
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_STATS_HP), gStringVar4, 30, 0, 0, 0);
    else
        PrintTextOnWindow(AddWindowFromTemplateList(sPageSkillsTemplate, PSS_DATA_WINDOW_SKILLS_STATS_HP), gStringVar4, 30, 0, 0, 0);
}
...
static void PrintNonHPStats(void)
{
    ...
    PrintTextOnWindow(windowId, gStringVar1, 58, 4, 0, 0);
    PrintTextOnWindow(windowId, gStringVar2, 58, 16, 0, 0);
    PrintTextOnWindow(windowId, gStringVar3, 58, 28, 0, 0);
    PrintTextOnWindow(windowId, gStringVar4, 58, 40, 0, 0);
    PrintTextOnWindow(windowId, sStringVar5, 58, 52, 0, 0);
}
...
static void PrintMovePowerAndAccuracy(u16 moveIndex)
{
    ...
    const u8 *power;
    const u8 *accuracy;
    FillWindowPixelBuffer(PSS_LABEL_WINDOW_MOVES_POWER_ACC, PIXEL_FILL(0));

    if (GET_LANGUAGE() == PT)
    {
        power = gText_PSS_Power_Pt;
        accuracy = gText_PSS_Accuracy_Pt;
    }
    else if (GET_LANGUAGE() == ES)
    {
        power = gText_PSS_Power_Es;
        accuracy = gText_PSS_Accuracy_Es;
    }
    else if (GET_LANGUAGE() == EN)
    {
        power = gText_PSS_Power_En;
        accuracy = gText_PSS_Accuracy_En;
    }
    else
    {
        power = gText_PSS_Power_En;
    ...
    AddTextPrinterParameterized3(PSS_LABEL_WINDOW_MOVES_POWER_ACC, FONT_SHORT, 0, 4, sTextColors[13], 0, power);
    AddTextPrinterParameterized3(PSS_LABEL_WINDOW_MOVES_POWER_ACC, FONT_SHORT, 0, 16, sTextColors[13], 0, accuracy);
    ...
    if (moveIndex != MOVE_NONE)
    {
        ...
        PrintTextOnWindow(PSS_LABEL_WINDOW_MOVES_POWER_ACC, text, 56, 4, 0, 0);
        ...
        PrintTextOnWindow(PSS_LABEL_WINDOW_MOVES_POWER_ACC, text, 56, 16, 0, 0);
    } else {
        text = gText_ThreeDashes;
        PrintTextOnWindow(PSS_LABEL_WINDOW_MOVES_POWER_ACC, text, 56, 4, 0, 0);
        PrintTextOnWindow(PSS_LABEL_WINDOW_MOVES_POWER_ACC, text, 56, 16, 0, 0);
...
static void PrintContestMoveDescription(u8 moveSlot)
{
    ...
    {
        windowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_MOVE_DESCRIPTION);
        description = gContestEffects[gMovesInfo[move].contestEffect].description;
        FormatTextByWidth(desc, 119, FONT_BW_SUMMARY_SCREEN, description, GetFontAttribute(FONT_BW_SUMMARY_SCREEN, FONTATTR_LETTER_SPACING));
        PrintTextOnWindow_BW_Font(windowId, desc, 0, 0, 0, 0);
    }
}

static void PrintContestAppealJamLabels(void)
{
    u8 windowId = AddWindowFromTemplateList(sPageMovesTemplate, PSS_DATA_WINDOW_CONTEST_APPEAL_JAM);
    const u8 *appeal;
    const u8 *jam;

    if (GET_LANGUAGE() == PT)
    {
        appeal = gText_PSS_Appeal_Pt;
        jam = gText_PSS_Jam_Pt;
    }
    else if (GET_LANGUAGE() == ES)
    {
        appeal = gText_PSS_Appeal_Es;
        jam = gText_PSS_Jam_Es;
    }
    else if (GET_LANGUAGE() == EN)
    {
        appeal = gText_PSS_Appeal_En;
        jam = gText_PSS_Jam_En;
    }
    else
    {
        appeal = gText_PSS_Appeal_En;
    ...
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 7, 3, sTextColors[13], 0, appeal);
    AddTextPrinterParameterized3(windowId, FONT_SHORT, 7, 16, sTextColors[13], 0, jam);
...
static void PokeSum_CreateMonIcon(void)
{
    ...
    species = GetMonData(&mon[sMonSummaryScreen->curMonIndex], MON_DATA_SPECIES_OR_EGG);
    personality = GetMonData(&mon[sMonSummaryScreen->curMonIndex], MON_DATA_PERSONALITY);

    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON] != SPRITE_NONE)
        DestroySprite(&gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON]]);

    SafeLoadMonIconPalette(species);

    sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON] = CreateMonIcon(species, SpriteCallbackDummy, 139, 26, 0, personality);

    if (!IsMonSpriteNotFlipped(species))
        gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON]].hFlip = TRUE;
    else
        gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON]].hFlip = FALSE;
...
{
    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON] != SPRITE_NONE)
        gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_ICON]].invisible = invisible;
}
...
static void PrintMoveDetails(u16 move)
{
    ...
    if (move != MOVE_NONE)
    {
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES)
        {
            ...
            if (BW_SUMMARY_AUTO_FORMAT_MOVE_DESCRIPTIONS)
            {
                ...
                PrintTextOnWindow_BW_Font(windowId, desc, 0, 10, 0, 0);
            }
            else
            {
                PrintTextOnWindow_BW_Font(windowId, GetMoveDescription(move), 0, 10, 0, 0);
            }
        ...
        else
        {
            ...
            {
                PrintTextOnWindow_BW_Font(windowId, description, 0, 10, 0, 0);
            }
        }
        PutWindowTilemap(windowId);
    }
    else
    {
        ...
        else
        {
            ...
            RemoveWindowByIndex(PSS_DATA_WINDOW_CONTEST_APPEAL_JAM);
        }
    }
...
static void ShowCategoryIcon(u16 move)
{
    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_CATEGORY] == SPRITE_NONE)
        sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_CATEGORY] = CreateSprite(&sSpriteTemplate_CategoryIcons, 220, 56, 0);
...
static void ShowGradeIcons(u8 mode)
{
    ...
    for (i = SPRITE_ARR_ID_HP_GRADE; i <= SPRITE_ARR_ID_SPE_GRADE; i++)
    {
        if (sMonSummaryScreen->spriteIds[i] == SPRITE_NONE)
        {
            ...
            sMonSummaryScreen->spriteIds[i] = CreateSprite(&sSpriteTemplate_StatGrades, 64, y, 0);
...
static void CreateCaughtBallSprite(struct Pokemon *mon)
{
    ...
    LoadBallGfx(ball);
    sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_BALL] = CreateSprite(&gPokeBalls[ball].spriteTemplate, 234, 38, 6);
...
static void GetNatureTextColor(u8 *color, s8 statIndex)
{
    if (statIndex == 0 
        || !BW_SUMMARY_NATURE_COLORS 
        || gNaturesInfo[sMonSummaryScreen->summary.mintNature].statUp ==
           gNaturesInfo[sMonSummaryScreen->summary.mintNature].statDown)
    {
        color[0] = 0;
        color[1] = 3;
        color[2] = 1;
