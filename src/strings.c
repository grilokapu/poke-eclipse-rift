...
const u8 gText_NothingToCutPt[] = _("Näo há nada para CORTAR.");
const u8 gText_CantSurfHerePt[] = _("Você näo pode SURFAR aqui.");
...
const u8 gText_CantUseHerePt[] = _("Näo pode usar isso aqui.");
...
const u8 gText_PokemonAreNeededPt[] = _("Säo necessários {STR_VAR_1} POKéMON.");
const u8 gText_PokemonCantBeSamePt[] = _("Os POKéMON näo podem ser iguais.");
const u8 gText_NoIdenticalHoldItemsPt[] = _("Näo é possível ter itens iguais.");
...
const u8 gText_YouHaveNoPokemonPt[] = _("Você näo tem POKéMON.");
