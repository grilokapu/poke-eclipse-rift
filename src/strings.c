...
const u8 gText_BoyPt[] = _("MENINO");
const u8 gText_GirlPt[] = _("MENINA");
const u8 gText_BoyEs[] = _("NIÑO");
const u8 gText_GirlEs[] = _("NIÑA");
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “POKéMON.”{PAUSE 96}\p");
const u8 gText_ThisIsAPokemonPt[] = _("Isto é o que chamamos de\n“POKéMON.”{PAUSE 96}\p");
const u8 gText_ThisIsAPokemonEs[] = _("Esto es lo que llamamos un\n“POKéMON.”{PAUSE 96}\p");
...
const u8 gText_ShopBuyPt[] = _("COMPRAR");
const u8 gText_ShopSellPt[] = _("VENDER");
const u8 gText_ShopQuitPt[] = _("SAIR");
const u8 gText_ShopQuitEs[] = _("SALIR");
...
const u8 gText_AnythingElseICanHelpPt[] = _("Há mais alguma coisa em que eu\npossa ajudar?");
const u8 gText_AnythingElseICanHelpEs[] = _("¿Hay algo más en lo que pueda\nayudarte?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Can I help you with anything else?");
const u8 gText_CanIHelpWithAnythingElsePt[] = _("Posso ajudar com mais alguma\ncoisa?");
const u8 gText_CanIHelpWithAnythingElseEs[] = _("¿Puedo ayudarte con algo más?");
...
const u8 gText_SavingBadgesPt[] = _("INSÍGNIAS:");
const u8 gText_SavingBadgesEs[] = _("MEDALLAS:");
const u8 gText_SavingPokedex[] = _("POKéDEX:");
const u8 gText_SavingTime[] = _("TIME:");
const u8 gText_SavingTimePt[] = _("TEMPO:");
const u8 gText_SavingTimeEs[] = _("TIEMPO:");
...
const u8 gText_PtLang[] = _("PORTUGUESE");
const u8 gText_SpLang[] = _("SPANISH");
const u8 gText_EngLang[] = _("ENGLISH");
const u8 gText_SelectLang[] = _("Select your language");
const u8 gText_LookCloserAtMap[] = _("{PLAYER} took a closer look at the\nHOENN region map.$");

// PT-BR
const u8 gText_ChoosePokemonPt[] = _("Escolha um POKéMON.");
const u8 gText_ChoosePokemonCancelPt[] = _("Escolha um POKéMON ou CANCELE.");
const u8 gText_ChoosePokemonConfirmPt[] = _("Escolha um POKéMON e confirme.");
const u8 gText_MoveToWherePt[] = _("Mover para onde?");
const u8 gText_TeachWhichPokemon2Pt[] = _("Ensinar qual POKéMON?");
const u8 gText_UseOnWhichPokemonPt[] = _("Usar em qual POKéMON?");
const u8 gText_GiveToWhichPokemonPt[] = _("Dar a qual POKéMON?");
const u8 gText_NothingToCutPt[] = _("Não há nada para CORTAR.");
const u8 gText_CantSurfHerePt[] = _("Você não pode SURFAR aqui.");
const u8 gText_AlreadySurfingPt[] = _("Você já está SURFANDO.");
const u8 gText_CurrentIsTooFastPt[] = _("A correnteza é forte demais!");
const u8 gText_EnjoyCyclingPt[] = _("Vamos pedalar!");
const u8 gText_InUseAlready_Pt[] = _("Isso já está em uso.");
const u8 gText_CantUseHerePt[] = _("Não pode usar isso aqui.");
const u8 gText_NoPokemonForBattlePt[] = _("Sem POKéMON para batalhar!");
const u8 gText_ChoosePokemon2Pt[] = _("Escolha um POKéMON.");
const u8 gText_NotEnoughHpPt[] = _("HP insuficiente…");
const u8 gText_PokemonAreNeededPt[] = _("São necessários {STR_VAR_1} POKéMON.");
const u8 gText_PokemonCantBeSamePt[] = _("Os POKéMON não podem ser iguais.");
const u8 gText_NoIdenticalHoldItemsPt[] = _("Não é possível ter itens iguais.");
const u8 gText_EmptyString2Pt[] = _("");
const u8 gText_DoWhatWithPokemonPt[] = _("O que fazer com o {PKMN}?");
const u8 gText_RestoreWhichMovePt[] = _("Restaurar qual movimento?");
const u8 gText_BoostPpPt[] = _("{UP_ARROW} PP de qual movimento?");
const u8 gText_DoWhatWithItemPt[] = _("O que fazer com o item?");
const u8 gText_DoWhatWithMailPt[] = _("O que fazer com o CORREIO?");
const u8 gText_AlreadyHoldingOnePt[] = _("{STR_VAR_1} já está segurando\num {STR_VAR_2}.");
const u8 gText_WhichAppliancePt[] = _("Qual aparelho\ndeseja usar?");
const u8 gText_NextFusionMonPt[] = _("Escolha o POKéMON para fundir.");
const u8 gText_YouHaveNoPokemonPt[] = _("Você não tem POKéMON.");
const u8 gText_SendWhichMonToPCPt[] = _("Enviar qual POKéMON para o PC?");
const u8 gText_MoveItemWherePt[] = _("Mover item para onde?");

// ESPAÑOL
const u8 gText_ChoosePokemonSpa[] = _("Elige un POKéMON.");
const u8 gText_ChoosePokemonCancelSpa[] = _("Elige un POKéMON o CANCELA.");
const u8 gText_ChoosePokemonConfirmSpa[] = _("Elige un POKéMON y confirma.");
const u8 gText_MoveToWhereSpa[] = _("¿Mover a dónde?");
const u8 gText_TeachWhichPokemon2Spa[] = _("¿Enseñar a qué POKéMON?");
...
const u8 gText_CantSurfHereSpa[] = _("No puedes SURFEAR aquí.");
const u8 gText_AlreadySurfingSpa[] = _("Ya estás SURFEANDO.");
const u8 gText_CurrentIsTooFastSpa[] = _("¡La corriente es demasiado fuerte!");
const u8 gText_EnjoyCyclingSpa[] = _("¡Disfruta el ciclismo!");
const u8 gText_InUseAlready_Spa[] = _("Esto ya está en uso.");
const u8 gText_CantUseHereSpa[] = _("No se puede usar eso aquí.");
const u8 gText_NoPokemonForBattleSpa[] = _("¡No tienes POKéMON para combatir!");
const u8 gText_ChoosePokemon2Spa[] = _("Elige un POKéMON.");
const u8 gText_NotEnoughHpSpa[] = _("HP insuficiente…");
const u8 gText_PokemonAreNeededSpa[] = _("Se necesitan {STR_VAR_1} POKéMON.");
const u8 gText_PokemonCantBeSameSpa[] = _("Los POKéMON no pueden ser iguales.");
const u8 gText_NoIdenticalHoldItemsSpa[] = _("No se permiten objetos iguales.");
const u8 gText_EmptyString2Spa[] = _("");
const u8 gText_DoWhatWithPokemonSpa[] = _("¿Qué hacer con este {PKMN}?");
const u8 gText_RestoreWhichMoveSpa[] = _("¿Restaurar qué movimiento?");
const u8 gText_BoostPpSpa[] = _("¿Aumentar PP de qué movimiento?");
const u8 gText_DoWhatWithItemSpa[] = _("¿Qué hacer con el objeto?");
const u8 gText_DoWhatWithMailSpa[] = _("¿Qué hacer con el CORREO?");
const u8 gText_AlreadyHoldingOneSpa[] = _("{STR_VAR_1} ya tiene\nun {STR_VAR_2}.");
const u8 gText_WhichApplianceSpa[] = _("¿Qué aparato\ndeseas usar?");
const u8 gText_NextFusionMonSpa[] = _("Elige el POKéMON para fusionar.");
const u8 gText_YouHaveNoPokemonSpa[] = _("No tienes POKéMON.");
const u8 gText_SendWhichMonToPCSpa[] = _("¿Enviar qué POKéMON al PC?");
const u8 gText_MoveItemWhereSpa[] = _("¿Mover objeto a dónde?");
