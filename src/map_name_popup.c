...
{
    [MAPSEC_PINEVEIL_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SYLVARA_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_STONEREACH_CITY] = MAPPOPUP_THEME_MARBLE,
...
{
    [MAPSEC_PINEVEIL_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SYLVARA_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_STONEREACH_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
