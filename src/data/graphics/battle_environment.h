...
const u16 gBattleEnvironmentPalette_TallGrassEvening[] = INCGFX_U16("graphics/battle_environment/tall_grass/palette_evening.pal", ".gbapal");
const u16 gBattleEnvironmentPalette_TallGrassNight[] = INCGFX_U16("graphics/battle_environment/tall_grass/palette_night.pal", ".gbapal");
...
const u16 gBattleEnvironmentPalette_LongGrassEvening[] = INCGFX_U16("graphics/battle_environment/long_grass/palette_evening.pal", ".gbapal");
const u16 gBattleEnvironmentPalette_LongGrassNight[] = INCGFX_U16("graphics/battle_environment/long_grass/palette_night.pal", ".gbapal");
...
const u16 gBattleEnvironmentPalette_SandEvening[] = INCGFX_U16("graphics/battle_environment/sand/palette_evening.pal", ".gbapal");
const u16 gBattleEnvironmentPalette_SandNight[] = INCGFX_U16("graphics/battle_environment/sand/palette_night.pal", ".gbapal");
