...
bool32 ScriptTakeSelectedPartyMon(void)
{
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_SYLVARA_TOWN_POKEMON_CENTER_1F,
        ...
        MAP_STONEREACH_CITY_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(MAP_SYLVARA_TOWN_MART),     MAP_NUM(MAP_SYLVARA_TOWN_MART),     LOCALID_SYLVARA_MART_CLERK },
        ...
        { MAP_GROUP(MAP_STONEREACH_CITY_MART),   MAP_NUM(MAP_STONEREACH_CITY_MART),   LOCALID_STONEREACH_MART_CLERK },
